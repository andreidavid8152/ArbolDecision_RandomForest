...
# 4. Pipeline de preprocesamiento + Árbol de Decisión
...
# 9. Entrenar un árbol solo con estas dos features
clf_vis = DecisionTreeClassifier(criterion="entropy", random_state=0)
